...
export default function Home() {
	...
	return ( 
		<motion.div initial={{ opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} transition={{duration: .5}} className="h-full w-full flex flex-col pb-5">
			<div className=" flex-1 flex flex-col items-start justify-center mt-32 gap-10">
				<div>
					<motion.h1 className={"text-gray-400 font-noticia-text text-4xl font-normal"}>AHMAD YOVAN</motion.h1>
					<motion.h1 className="text-[#7E00BA] font-noticia-text text-3xl font-normal">PORTFOLIO</motion.h1>
				</div>
