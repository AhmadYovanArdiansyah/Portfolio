...
const About = () => {
    ...
    return (
        <motion.div variants={animation} initial="enter" animate="show" exit="exit" transition={{duration: .5}} className="h-full w-full flex flex-col justify-center pb-24 gap-14">
            <motion.div className="text-2xl font-play text-gray-400">
                <p className="px-20 md:px-0 md:w-[30rem]">
